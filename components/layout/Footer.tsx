...
export default function Footer({ onToggleAts, ats }: { onToggleAts: () => void; ats: boolean }) {
  return (
      ...
      <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {ats ? "Exit recruiter mode" : "Recruiter mode"}
          </button>

          <a
            href="#top"
            aria-label="Back to top"
            className="ats-hide grid size-9 place-items-center rounded-full border border-white/10 text-muted transition-all duration-300 hover:-translate-y-0.5 hover:text-text"
          >
